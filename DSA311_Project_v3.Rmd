...
```{r cars}
# heart_data$num = ifelse(heart_data$num ==0,"Zero","One")
# unique(heart_data$num)
# 
# attach(heart_data)
# #check
# # heart_data <- heart_data %>% mutate(num1 = ifelse(heart_data$num ==0,0,1))
# head(heart_data)
...
## Using on scaled data is arugably worse
...
### Use logistic regression on scaled data
